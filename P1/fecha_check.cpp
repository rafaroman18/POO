// $Id: fecha_check.cpp 379 2017-03-22 18:33:06Z gerardo $
...
int main(int argc, const char **argv)
{
  ...
  if(c.findClass("Fecha")){
    ...
    c.includedHeader(functionNames, headerName, true, "Revisa de dónde son tomadas las funciones ssprintf y sscanf.");
